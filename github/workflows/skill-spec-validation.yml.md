...
jobs:  
  validate:  
    ...
    steps:  
      ...
      \# to stay nested objects (see NESTED\_OK below).  
        ...
        run: |  
          ...
          for d in sorted(Path("skills").iterdir()):  
              ...
              if not m\_fm:  
                  ...
                  continue  
              fm \= yaml.safe\_load(m\_fm.group(1))
              ...
              if not isinstance(m, dict):  
                  ...
                  for k, v in m.items():  
                      if k in NESTED\_OK:  
                          if not isinstance(v, dict):  
                              errors.append(  
                                  ...
                                  f"{type(v).\_\_name\_\_} \-- a JSON string silently disables "  
                      ...
                      if isinstance(v, str):  
                          continue  
                      errors.append(  
                          f"{md}: metadata.{k} must be a string, got {type(v).\_\_name\_\_} "  
